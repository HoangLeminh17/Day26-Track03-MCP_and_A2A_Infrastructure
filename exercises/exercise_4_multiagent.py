...
def check_routing(state: State) -> dict:
    """Danh dau xem can goi specialist nao."""
    ...
    return {
        ...
        "needs_privacy": any(kw in question_lower for kw in ["data", "privacy", "gdpr", "du lieu"]),
    }


def route_to_specialists(state: State) -> list[Send]:
    """Tra ve cac nhanh Send song song cho specialist agents."""
    tasks: list[Send] = []
